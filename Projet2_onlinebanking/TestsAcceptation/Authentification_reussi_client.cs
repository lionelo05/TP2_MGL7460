...
{
    [TestClass]
    public class AuthentificationReussieClient
    {
        ...
        [TestMethod]
        public void TheAuthentificationReussieClientTest()
        {
            ...
            driver.FindElement(By.Id("MainContent_Password")).SendKeys("lionel05");
            driver.FindElement(By.Name("ctl00$MainContent$ctl05")).Click();
            Assert.IsTrue(IsElementPresent(By.Id("client")));
        }
