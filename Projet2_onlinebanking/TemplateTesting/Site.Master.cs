...
namespace TemplateTesting
{
    public partial class SiteMaster : MasterPage
    {
        ...
        {
            this.FindControl("admin").Visible = false;
            this.FindControl("customer").Visible = false;

            if(Context.User.Identity.IsAuthenticated)
             {
                
                   if (Context.User.Identity.GetUserName() == "lionel")
                   {
                        this.FindControl("admin").Visible = true;
                        this.FindControl("customer").Visible = false;
                   }
                   else{
                        this.FindControl("admin").Visible = false;
                        this.FindControl("customer").Visible = true;
                    }
             }
        }
