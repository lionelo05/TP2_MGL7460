<%@ Page Title="Se connecter" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TemplateTesting.Banque.Login" Async="true" %>
    ...
    <div class="row">
        <div class="col-md-8">
            <section id="loginForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="UserName"
                                CssClass="text-danger" ErrorMessage="Le champ nom d'utilisateur est requis." />
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <p>
                    <asp:HyperLink runat="server" ID="ContactHyperLink" ViewStateMode="Disabled">Nous contacter</asp:HyperLink>
                    si vous ne possédez pas de compte bancaire.
                </p>
            </section>
        </div>
